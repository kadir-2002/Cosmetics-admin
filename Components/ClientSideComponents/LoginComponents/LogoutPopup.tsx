...
const LogoutPopup: React.FC<LogoutPopupProps> = ({
  ...
  return (
    <Transition.Root show={isLogoutDialogOpen} as={Fragment}>
      <Dialog
        as="div"
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:px-6 flex  justify-between gap-3 cursor-pointer	">
                  <div onClick={() => handleLogout()}>
                    <div>Logout</div>
                  </div>
                  <div onClick={() => setIsLogoutDialogOpen(false)}>
                    <div>
