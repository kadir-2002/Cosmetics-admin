...
const SubCategryDeletepopComponent: React.FC<LogoutPopupProps> = ({
    isOpenDeletePopup,
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                 Are you sure you want to delete this Sub categry ?
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
export default SubCategryDeletepopComponent;
